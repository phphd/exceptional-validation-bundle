...
final class CaptureMatchConditionFactory implements MatchConditionFactory
{
    public function __construct(
        ...
        private readonly MatchConditionFactory $matchByExceptionClassConditionFactory = new MatchByExceptionClassConditionFactory(),
        private readonly MatchConditionFactory $matchWithClosureConditionFactory = new MatchWithClosureConditionFactory(),
    ) {
    }
