...
use PhPhD\ExceptionalValidation\Model\Condition\MatchByInvalidValueExceptionCondition;
use PhPhD\ExceptionalValidation\Model\Condition\MatchCondition;
use PhPhD\ExceptionalValidation\Model\Rule\CaptureRule;

/** @internal */
final class MatchByInvalidValueExceptionConditionFactory implements MatchConditionFactory
{
    public function getCondition(Capture $capture, CaptureRule $parent): ?MatchCondition
    {
        ...
        return new MatchByInvalidValueExceptionCondition($value);
    }
}
